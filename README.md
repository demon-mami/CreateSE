...
## 正式内蔵Hitsound：Current111 ABC Sorted v5

- 正式素材 **111音源**のみを収録
- 全ファイル：48 kHz / 24-bit PCM / Stereo WAV
- 表示番号：素材管理番号 **SRC-001〜SRC-116**（018 / 044 / 075 / 103 / 104は欠番）
- ドラム系統カテゴリーとA / B / C分類を併記
- 配布パック：`hitsounds-current111-abc-v5.zip`
...
- 候補選択時の単音再生でもMusic / Hitsoundのゲインは変更しません
...
データセットごとにFavoriteと削除候補の保存領域を分離しています。Current111で選び直した結果のみを新しい比較結果として扱います。
